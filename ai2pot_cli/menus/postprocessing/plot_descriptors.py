...
def plot_descriptor_projection(
    ...
    if trainset_path:
        ...
        np.save(os.path.join(out_dir, "train_descriptors.npy"), train_desc)
        np.save(os.path.join(out_dir, "train_atomic_numbers.npy"), train_z)
    ...
    if testset_path:
        ...
        np.save(os.path.join(out_dir, "test_descriptors.npy"), test_desc)
        np.save(os.path.join(out_dir, "test_atomic_numbers.npy"), test_z)
